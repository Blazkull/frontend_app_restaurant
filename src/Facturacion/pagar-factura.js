...
const productosFactura = [
    { id: 1, nombre: 'Aros de Cebolla Gourmet', cantidad: 1, precioUnitario: 1200, descuento: 0 },
    { id: 2, nombre: 'Limonada de Menta Refrescante', cantidad: 1, precioUnitario: 300, descuento: 50 },
    { id: 3, nombre: 'Pizza Margarita Artesanal', cantidad: 2, precioUnitario: 850, descuento: 0 },
    { id: 4, nombre: 'Salmón a la Plancha con Asparagus', cantidad: 1, precioUnitario: 900, descuento: 0 }
];
